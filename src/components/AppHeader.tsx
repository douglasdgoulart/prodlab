...
import { ProdLabLogo } from './ProdLabLogo';
import { useAuth } from '../hooks/use-auth';

const NAV_ITEMS = [
  { label: 'Módulos', href: '#', active: true },
  { label: 'Recursos', href: '#', active: false },
  { label: 'Notas', href: '#', active: false },
];
  ...
  return (
    <header className="flex items-center justify-between border-b border-border bg-card px-4 py-3 lg:px-8">
      ...
      <div className="flex items-center gap-3">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger className="flex items-center gap-3 rounded-lg px-2 py-1.5 transition-colors hover:bg-muted min-h-[44px]">
